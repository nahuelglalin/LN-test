        ...
        <footer className='footer'>
            <div className="lay">
                <section className="footer-header">
                    <section className="col-4 footer-redes">
                        <div>
                    ...
                    <section className="col-4 footer-logo">
                        <Link to="/"><img className="img-logo" src="https://upload.wikimedia.org/wikipedia/commons/2/28/Logo_La_Naci%C3%B3n.svg" alt="" /> </Link>
                    </section>
                    <section className="col-4 footer-app">
                        ...
                        <a href="https://apps.apple.com/ar/app/la-nacion/id410689702" className="app_ios">
                            <svg xmlns="http://www.w3.org/2000/svg" width="120" height="35" viewBox="0 0 120 35">
                                <g fill="none" fillRule="evenodd">
                                    <rect width="119.862" height="35" fill="#5A5A5A" rx="3"></rect>
                ...
                <section className="footer-sitio">
                    <div className="col-9 footer-links">
                        <p className="item_link">Mapa del sitio</p>
                        <p className="item_link">Ayuda</p>
                        <p className="item_link">Términos y condiciones</p>
                        <p className="item_link">¿Cómo anunciar?</p>
                        <p className="item_link">Suscribirse al diario impreso</p>
                    </div>
                    <div className="col-3 footer-captcha">
                        <p>Protegido por re CAPTCHA:
                            <a href="https://policies.google.com/terms?hl=es-419" className="condition">
                                Condiciones
                            </a>
                            <a href="https://policies.google.com/privacy?hl=es-419" className="private">
                                Privacidad
                            </a>
                        </p>
                    </div>
                ...
                <section className="footer-copyright">
                    <section className="col-desksm-6 col-desk-6 footer-copyright-reserved">
                        <p>Copyright 2019 SA LA NACION | Todos los derechos reservados</p>
                    </section>
                    <section className="footer-copyright-fiscal">
                        <p>
                            <img
